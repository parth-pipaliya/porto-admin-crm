        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-body panel-body">
                    ...
                    <form method="POST" action="{{route('admin.user.store')}}" id="user_form" name="user_form">
                        @csrf
                                ...
                                <h4 class="mt-0 mb-0 header-title mb-5">User Details</h4>
                                 <div class="card-detail-list">
                                    <div class="row mb-3">
                                        ...
                                        <dd class="col-sm-7"> 
                                            <select id="category_id" disabled type="text" required class="form-control" name="category_id" >
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <dd class="col-sm-7"> 
                                            <select id="subcategory_id" disabled  type="text" required class="form-control" name="subcategory_id" >
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <dd class="col-sm-7"> 
                                           <input type="text" disabled class="form-control" name="first_name" value="{{$data->first_name}}"> 
                                        </dd>
                                    </div>
                                    <div class="row mb-3">
                                        <dt class="col-sm-5"><label>Last Name</label></dt>
                                        <dd class="col-sm-7"> 
                                           <input type="text" disabled class="form-control" name="last_name" value="{{$data->last_name}}"> 
                                        </dd>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <dd class="col-sm-7"> 
                                          <input type="text" disabled class="form-control" name="country_code" value="{{$data->country_code}}"> 
                                        </dd>
                                    </div>
                                    <div class="row mb-3">
                                        <dt class="col-sm-5"><label>Mobile No</label></dt>
                                        <dd class="col-sm-7"> 
                                          <input type="text" disabled class="form-control" name="mobile_no" value="{{$data->mobile_no}}"> 
                                        </dd>
                                    </div>
                                    <div class="row mb-3">
                                        <dt class="col-sm-5"><label>Gender</label></dt>
                                        <dd class="col-sm-7"> 
                                            <input class="mr-1" disabled type="radio" id="gender_male" name="gender" value="0" {{($data->gender == '0') ? 'checked' :''}}><label for="gender_male">Male</label>
                                            <input class="ml-3 mr-1" disabled type="radio" id="gender_female" name="gender" value="1" {{($data->gender == '1') ? 'checked' :''}}><label for="gender_female">Female</label>
                                        </dd>
                                    </div>
                                    <div class="row mb-3">
                                        <dt class="col-sm-5"><label>Status</label></dt>
                                        <dd class="col-sm-7"> 
                                            <input type="radio" disabled class="mr-1" id="status_active" name="status" value="1" {{($data->status == '1') ? 'checked' :''}}><label for="status_active">Active</label>
                                            <input type="radio" disabled class="ml-3 mr-1" id="gender_inactive" name="status" value="2" {{($data->status == '2') ? 'checked' :''}}><label for="gender_inactive">Inactive</label>
                                            <input type="radio" disabled class="ml-3 mr-1" id="gender_pending" name="status" value="3" {{($data->status == '3') ? 'checked' :''}}><label for="gender_pending">Verify Pending</label>
                                        </dd>
                                    </div>
                                </div>
                            </div>
