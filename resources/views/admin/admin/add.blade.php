        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-body panel-body">
                    ...
                    <form method="POST" action="{{route('admin.admin_user.store')}}" id="user_form" name="user_form">
                        @csrf
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 custom-multi-select">
                                <label>Role</label>
                                <select id="roles" name="roles[]" placeholder="Role" class="form-control @error('roles') is-invalid @enderror" multiple="multiple" 
                            ...
                            <div class="form-group col-md-6">
                                <label>Status</label>
                                <select  type="text" class="form-control @error('is_active') is-invalid @enderror" name="is_active" >
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="is_superadmin" id="is_superadmin"   {{isset($data->is_superadmin) && $data->is_superadmin == '1' ? 'checked' : ''}}>
